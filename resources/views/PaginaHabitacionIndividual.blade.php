...
<center>
    <h1 class="detallesHabitacion">Detalles de la habitacion numero {{ $habitacion->Num_Habitacion }}  <a  class="btn btn-warning" href="{{route('habitacion.edit', ['id'=>$habitacion->id])}}">Editar</a></h1>
    <div class="card">
        <div class="card-body">
